...
Follow [PRODUCT_CONSTITUTION.md](file:///Users/amar/Documents/Activity%20Finder/activity-finder/docs/PRODUCT_CONSTITUTION.md) as the highest-priority specification. If any implementation conflicts with it, the constitution takes precedence.

- **Course First. Studio Second.**
- Platform exists to help users find activities that fit their free time and location.

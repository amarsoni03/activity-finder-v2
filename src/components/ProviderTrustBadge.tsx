    ...
    return (
      <div className={`relative inline-flex items-center ${className}`}>
        <button
          ...
          className="inline-flex items-center space-x-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-200/70 transition-colors cursor-pointer"

      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/80 transition-all h-16 sm:h-18 flex items-center text-slate-900 shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6 select-none">
            ...
            >
              <div className="w-8 h-8 sm:w-9 sm:h-9 bg-[#A2FF00] text-[#111827] rounded-xl flex items-center justify-center font-black text-base sm:text-lg transition-transform group-hover:scale-105 shadow-xs">
                M
              </div>
          ...
          {/* 2. Desktop Primary Search Trigger (Hidden on homepage to avoid hero search redundancy) */}
          {showSearch ? (
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            {/* Action 1: AI Activity Concierge (WCAG AA Compliant contrast with #111827 text) */}
            <button
              onClick={onOpenAiMatchmaker}
              className="flex items-center space-x-1.5 px-3.5 py-2 bg-[#A2FF00] hover:bg-[#91E600] text-[#111827] text-xs font-black rounded-full transition-all cursor-pointer shadow-xs hover:shadow-md active:scale-95"
              title="AI Activity Concierge"
            >
              <Sparkles className="w-3.5 h-3.5 fill-[#111827] text-[#111827]" />
            ...
            >
              ...
              {savedCount > 0 && (
                <motion.span
                  ...
                  className="absolute -top-1 -right-1 min-w-4 h-4 px-1 bg-[#A2FF00] text-[#111827] text-[10px] font-extrabold rounded-full flex items-center justify-center ring-2 ring-white"
                >
            ...
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                <button
                  ...
                  aria-label="Go to homepage"
                >
                  <div className="w-9 h-9 bg-[#A2FF00] text-[#111827] rounded-xl flex items-center justify-center font-black text-base shadow-2xs">
                    M
                  </div>
              ...
              <div className="py-4 space-y-1.5 text-xs">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between px-3.5 py-3 bg-gradient-to-r from-[#A2FF00]/15 via-emerald-500/10 to-transparent border border-[#A2FF00]/40 text-[#111827] hover:bg-[#A2FF00]/25 font-bold rounded-xl transition-all cursor-pointer my-1"
                >
                  <div className="flex items-center space-x-3">
                    <Sparkles className="w-4 h-4 text-[#111827]" />
                    <span>AI Activity Concierge</span>
                  </div>
                  <span className="bg-[#A2FF00] text-[#111827] text-[10px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider">
                    AI Match
                  </span>
                </button>
                ...
                >
                  ...
                  {savedCount > 0 && (
                    <span className="min-w-5 h-5 px-1.5 bg-[#A2FF00] text-[#111827] text-[11px] font-extrabold rounded-full flex items-center justify-center">
                      {savedCount > 99 ? '99+' : savedCount}
                    </span>
                  )}
                </button>

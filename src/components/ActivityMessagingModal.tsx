...
export const ActivityMessagingModal: React.FC<ActivityMessagingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/40 backdrop-blur-xs" style={{ animation: 'fadeIn .15s ease-out' }}>
      <div className="bg-white rounded-2xl sm:rounded-3xl max-w-lg w-full shadow-2xl border border-slate-200/70 overflow-hidden flex flex-col h-[85vh] sm:h-[75vh]">

        {/* ── Header ── */}
        <div className="px-4 sm:px-5 py-3 flex items-center justify-between shrink-0 border-b border-slate-100">
          <div className="flex items-center space-x-2.5">
            {showBackButton && (
              <button onClick={goToInbox} className="p-1 text-slate-400 hover:text-slate-900 rounded-lg hover:bg-slate-100 transition-colors cursor-pointer -ml-1">
            ...
            <div>
              <h3 className="text-sm font-bold text-slate-900 leading-tight">Messages</h3>

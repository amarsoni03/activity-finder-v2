      ...
      <div className="flex-1 min-w-0 flex flex-col gap-0.5">
        ...
        <div className="flex items-center justify-between gap-2 mt-1.5 pt-1.5 border-t border-slate-100">
          ...
          <button
            ...
            className={`shrink-0 px-3 py-2 text-[11px] font-bold rounded-lg min-h-[36px] flex items-center gap-1 cursor-pointer transition-all ${
              seatsLeft === 0
                ? 'bg-amber-400 text-[#111827] font-black'
                : 'bg-[#A2FF00] hover:bg-[#91E600] text-[#111827] font-black'
            }`}
          >

      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <motion.div
            ...
            className="relative z-10 bg-white w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl shadow-2xl border border-slate-100 overflow-hidden flex flex-col max-h-[90vh] sm:max-h-[85vh] focus:outline-none"
          ...
          >
            ...
            <div className="px-5 sm:px-6 py-4 sm:py-5 border-b border-slate-100 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 id="saved-modal-title" className="text-lg font-bold text-slate-900 leading-tight">Saved Activities</h2>
              ...
              <motion.button
                ...
                aria-label="Close saved activities"
              >
                <X className="w-5 h-5" />
              </motion.button>
            </div>
